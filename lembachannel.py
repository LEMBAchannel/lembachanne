...
def banner():
    ...
    autoketik (f"""
     ...
     \033[1;0m──────────────────────────┬─────────────────────────
  \033[1;0m┌────────────────────────────┼───────────────────────────┐
  {W}│ Creator{R}:{W}Lemba            │ Version {R}:{G} 3.0{W}             │
  {W}| Addition{R}:{W}Lemba        |                        {W}   |
  {W}│ Github{R}:{G}github.com/LEMBAchannel  {W}│ {W}Your Ip {R}:{Y} {ip}      {W}│
  {W}│ Youtube{R}:{W}LEMBA {biru}Ganz         {W}│ Perfect Brutal {biru}Sms Tools  {W}│
  └────────────────────────────┼───────────────────────────┘""")
...
def start(): # Def Untuk Start Tools
    ...
    if pil == "2":
        ...
        tanya()
    if pil == "3":
        os.system("xdg-open https://youtube.com/@lembachannel9315")
